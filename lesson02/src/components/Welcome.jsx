...
export default function Welcome() {
    ...
    //         ㄴ useState로 선언된 변수는 상태변수 : getElementbyId('').textcontent='값' 코드의 비효율성 개선
